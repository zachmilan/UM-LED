...
Assembly was done using a stencil + hot-plate as well as hand soldering for necessary parts. This is the first version of the remote PCB (and hopefully the last) and it functions as intended after some debugging and rework. Photos of the assembled remote exist below: 
